<div class="box product_wrapper">
  ...
  <div class="box-content">
   <?php if($this->config->get('fortis_bestseller_carousel') == 'enabled'){ ?>
    <a id="bestseller_prev" class="slide_arrow_prev"></a>
    <a id="bestseller_next" class="slide_arrow_next"></a>
...
<script type="text/javascript">
	...
	$('.box-product.bestseller.carousel').carouFredSel( {
		width:"100%",
