    ...
    <table>
      ...
      <tbody id="wishlist-row<?php echo $product['product_id']; ?>">
        <tr>
          ...
          <small><?php echo $column_model; ?>: <?php echo $product['model']; ?></small><br />
          <small><?php echo $column_stock; ?>: <?php echo $product['stock']; ?></small><br />
          ...
          <td class="price mobile_hide"><?php if ($product['price']) { ?>
            ...
            <?php } ?></td>
          <td class="action">
          <img src="catalog/view/theme/default/image/cart-add.png" alt="<?php echo $button_cart; ?>" title="<?php echo $button_cart; ?>" onclick="addToCart('<?php echo $product['product_id']; ?>');" />&nbsp;&nbsp;<a href="<?php echo $product['remove']; ?>" title="<?php echo $button_remove; ?>" class="removebutton"></a></td>
        </tr>
      </tbody>
      <?php } ?>
    </table>
