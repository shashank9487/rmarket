...
class ControllerCommonCart extends Controller {
	...
	public function products() {
		/*snippet for checking whether item is exist in cart or not*/
		foreach ($this->cart->getProducts() as $cart_products) {
			$product_ids_in_cart[]=$cart_products['product_id'];
		}
		if (isset($product_ids_in_cart)) {
			$data['cart_products'] = $product_ids_in_cart;
			echo json_encode($data);
		} else {
			$data['cart_products'] = 'false';
			echo json_encode($data);
		}
		/*snippet closed*/
	}
